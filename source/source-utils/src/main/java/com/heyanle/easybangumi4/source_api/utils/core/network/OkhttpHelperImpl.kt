...
import com.heyanle.easybangumi4.source_api.utils.core.network.interceptor.CloudflareInterceptor
import com.heyanle.easybangumi4.source_api.utils.core.network.interceptor.CloudflareUserInterceptor
import com.heyanle.easybangumi4.source_api.utils.core.network.interceptor.CookieInterceptor
import com.heyanle.easybangumi4.source_api.utils.core.network.interceptor.UserAgentInterceptor
...
/**
 * Created by HeYanLe on 2023/10/19 0:27.
...
class OkhttpHelperImpl(
    ...
    private val cloudflareInterceptor by lazy { CloudflareInterceptor(context, networkHelper, stringHelper) }
    private val cloudflareUserInterceptor by lazy { CloudflareUserInterceptor(context, networkHelper, stringHelper, webViewHelper) }
