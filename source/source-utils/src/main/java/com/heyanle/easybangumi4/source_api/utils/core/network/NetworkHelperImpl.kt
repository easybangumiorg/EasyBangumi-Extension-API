...
import com.heyanle.easybangumi4.source_api.utils.core.getDefaultUserAgentString
import kotlin.random.Random

/**
 * Created by HeYanLe on 2023/10/19 0:11.
...
class NetworkHelperImpl(
    ...
    override val cookieManager: AndroidCookieJar = _cookieManager

    private val _defaultLinuxUA =
        "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36 Edg/108.0.1462.76"
    private val defaultUA: String by lazy {
        kotlin.runCatching {
    ...
    override val defaultLinuxUA: String
        get() = _defaultLinuxUA
